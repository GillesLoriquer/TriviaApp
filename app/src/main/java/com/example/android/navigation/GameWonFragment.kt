...
class GameWonFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        // SHARING MENU
        // 1. Tells Android that our GameWonFragment has a menu
    ...
    override fun onCreateOptionsMenu(menu: Menu?, inflater: MenuInflater?) {
        ...
        // 4. Check if the activity resolves
    ...
    // SHARING MENU
    // 5. We need to override onOptionsItemsSelected to link menu to shareSuccess()
    ...
    private fun getShareIntent() : Intent {
        ...
        // SHARE INTENT - Implicit Intent
        val shareIntent = Intent(Intent.ACTION_SEND)
        with(shareIntent) {
            type = "text/plain"
            putExtra(Intent.EXTRA_TEXT, getString(R.string.share_success_text, args.numQuestions, args.numCorrects))
        }
